            ...
            if($result->num_rows > 0) {
               ...
               <div class="column">
					<div class="card">
									  ...
									  <div class="footer">
									  <a class="btn" id="next" href="sp.php?id='.$row["id"].'" ripple="" ripple-color="#666666">More</a></div>
									</div>
								  </div>  
            ...
            if($result1->num_rows > 0) {
               ...
               <div class="column">
					<div class="card">
									  ...
									  <div class="footer"><a class="btn" id="next" href="#" ripple="" ripple-color="#666666">More</a></div>
									</div>
								  </div>              
               ';
            ...
            if($result4->num_rows > 0) {
               ...
               ';
				...
				<nav>
					...
					<a href="login.php"><span id="bb-nav-next"><i class="fas fa-lock"></i></span></a>
				</nav>


				<span id="tblcontents" class="menu-button">Table of Events</span>
